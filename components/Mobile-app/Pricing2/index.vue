  ...
  <section :class="`app-price section-padding`">
    <div class="container">
      ...
      <div class="pric-tables">
        <div class="row">
          <div class="col-lg-4" v-for="plan, index in pricing" :key="plan.id">
            <div :class="`item sm-padding ${index !== pricing.length - 1 ? 'sm-mb50':''} ${plan.status === 'active' ? 'active':''}`">
...
import pricing from "../../../data/mobile-app/pricing2.json";
