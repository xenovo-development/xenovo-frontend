      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-6 no-padding">
            <swiper class="swiper-wrapper swiper-container swiper-img" ref="myImageSwiper" :options="swiperImageOptions"
          ...
          <div class="col-lg-6 no-padding valign">
            <swiper class="swiper-wrapper swiper-container swiper-content" :options="swiperTextOptions">
              <swiper-slide class="swiper-slide">
        ...
        <div class="controls">
          <div ref="navigationNextRef" class="swiper-button-next swiper-nav-ctrl next-ctrl">
            <i class="fas fa-caret-up"></i>
          </div>
          <div ref="navigationPrevRef" class="swiper-button-prev swiper-nav-ctrl prev-ctrl">
